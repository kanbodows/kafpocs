#include "otchetstudenty.h"
#include "ui_otchetstudenty.h"
#include <QMessageBox>
#include <QList>
bool OtchetStudenty::isOpen = false;
OtchetStudenty::OtchetStudenty(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::OtchetStudenty)
{
    ui->setupUi(this);
    if (! this->isOpen)
    {
...
OtchetStudenty::~OtchetStudenty()
{
    this->isOpen = false;
    delete ui;
}

void OtchetStudenty::printDocument(QPrinter *printer)
{
    body->print(printer);
}
...
void OtchetStudenty::on_pushButton_graph_clicked()
{
    /*QLayoutItem* item;
...
void OtchetStudenty::on_pushButton_set_clicked()
{
